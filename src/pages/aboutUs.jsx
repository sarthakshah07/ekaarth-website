     ...
     <Grid2 size={{ xs: 12 ,md:6}}>
      ...
      >
        ...
        <Grid2 container justifyContent={"center"}>
          <Grid2 size={10}>
            <Typography variant="body1" textAlign={"center !important"}>
              ...
              Interior and Landscape designing. EDS is a platform which gives
              the opportunity to the people to join hands and create a healthy
              lifestyle with less harm to the nature and more comfort to 
              people. 
            </Typography>
            <Typography variant="body1" textAlign={"center !important"}>
            <span style={highlighedText}>“Ekaarth"</span> is a
        ...
        <Grid2 container spacing={6} py={4}>
          ...
          /> */}
            <Typography variant="body1">
              ...
              “EDS,” represent the{" "}
              <span style={highlighedText}>Equilibrium</span> in we strive for
              between the{" "}
              <span style={highlighedText}>Past, Present, and Future.</span> We
              draw inspiration from India’s rich traditions and cultural
              heritage (Past), combine them with modern design principles and
              practical solutions (Present), and look toward creating
              environments that will stand the test of time (Future). This
              balance of old and new guides everything we do at Ekaarth Design
              Studio.
            </Typography>
          </Grid2>
          <Grid2 size={12}>
          ...
          <Grid2
            ...
            sx={{
              backgroundImage: `url(${AboutUsData.arcitectImage})`,
