      ...
      <Grid2 container spacing={2} pb={4} py={2}>
        ...
        >
          <Typography variant="body1">
            <span style={{ fontWeight: "bold" }}>Address- </span>04, 2nd floor,
            1FA, above HDFC bank, Sector F, Scheme 94, Indore, Madhya Pradesh
            452001
          </Typography>
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            ...
            connect@ekaarthdesignstudio.com, career@ekaarthdesignstudio.com
          </Typography>
        </Grid2>
